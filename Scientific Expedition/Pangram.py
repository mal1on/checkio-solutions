def check_pangram(text: str) -> bool:
    # your code here
    return all(let in text.lower() for let in 'abcdefghijklmnopqrstuvwxyz')
...
assert check_pangram(
    "As quirky joke, chefs won't pay devil magic zebra tax.") == True
assert check_pangram(
    "Six big devils from Japan quickly forgot how to walt.") == False
